...
system load se incrementa cuando descargo con qbittorrent, el puerto del router se satura tb?  puede tener scrub algo que ver? se estaba lanzando cuando pasó esto